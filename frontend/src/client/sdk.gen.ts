...
export class DouyinService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns CrawlTaskBulkResumePublic Successful Response
     * @throws ApiError
     */
    public static bulkResumeTasks(data: DouyinBulkResumeTasksData): CancelablePromise<DouyinBulkResumeTasksResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/douyin/tasks/bulk-resume',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
     ...
     * @throws ApiError
     */
    public static createOnlinePreviewSession(data: DouyinCreateOnlinePreviewSessionData): CancelablePromise<DouyinCreateOnlinePreviewSessionResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/douyin/tasks/{task_id}/awemes/{aweme_id}/online-preview-session',
            path: {
                task_id: data.taskId,
                aweme_id: data.awemeId
            },
     ...
     * @param data.awemeId
     * @param data.range
     * @param data.douyinOnlinePreview
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static previewOnlineMedia(data: DouyinPreviewOnlineMediaData): CancelablePromise<DouyinPreviewOnlineMediaResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/tasks/{task_id}/awemes/{aweme_id}/online-preview',
            path: {
                task_id: data.taskId,
                aweme_id: data.awemeId
            },
            cookies: {
                douyin_online_preview: data.douyinOnlinePreview
            },
            headers: {
                Range: data.range
            },
     ...
     * @returns DouyinMineSummaryPublic Successful Response
     * @throws ApiError
     */
    public static getMineSummary(data: DouyinGetMineSummaryData): CancelablePromise<DouyinGetMineSummaryResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/summary',
            query: {
     ...
     * @param data.skip
     * @param data.limit
     * @returns DouyinFollowingsPublic Successful Response
     * @throws ApiError
     */
    public static getMineFollowings(data: DouyinGetMineFollowingsData): CancelablePromise<DouyinGetMineFollowingsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/followings',
            query: {
                account_id: data.accountId,
                search: data.search,
                sort_by: data.sortBy,
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns DouyinFollowingsPromoteResult Successful Response
     * @throws ApiError
     */
    public static promoteMineFollowings(data: DouyinPromoteMineFollowingsData): CancelablePromise<DouyinPromoteMineFollowingsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @param data.skip
     * @param data.limit
     * @returns DouyinAccountAwemesPublic Successful Response
     * @throws ApiError
     */
    public static getMineAwemes(data: DouyinGetMineAwemesData): CancelablePromise<DouyinGetMineAwemesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/awemes',
            query: {
                account_id: data.accountId,
                kind: data.kind,
                search: data.search,
...
export class DouyinAccountsService {
     ...
     * @returns DouyinLocalBrowsersPublic Successful Response
     * @throws ApiError
     */
    public static listLocalBrowsersRoute(): CancelablePromise<DouyinAccountsListLocalBrowsersRouteResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/accounts/local-browsers'
        });
    }
    
    /**
     * Create Local Browser Route
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns DouyinLocalBrowserPublic Successful Response
     * @throws ApiError
     */
    public static createLocalBrowserRoute(data: DouyinAccountsCreateLocalBrowserRouteData): CancelablePromise<DouyinAccountsCreateLocalBrowserRouteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/douyin/accounts/local-browsers',
            body: data.requestBody,
    ...
    /**
     * Update Local Browser Route
     * 更新本机浏览器实例的展示名称或启用状态。
     *
     * 异常：
     * HTTPException: 404 实例不存在。
     * @param data The data for the request.
     * @param data.browserId
     * @param data.requestBody
     * @returns DouyinLocalBrowserPublic Successful Response
     * @throws ApiError
     */
    public static updateLocalBrowserRoute(data: DouyinAccountsUpdateLocalBrowserRouteData): CancelablePromise<DouyinAccountsUpdateLocalBrowserRouteResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/douyin/accounts/local-browsers/{browser_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteLocalBrowserRoute(data: DouyinAccountsDeleteLocalBrowserRouteData): CancelablePromise<DouyinAccountsDeleteLocalBrowserRouteResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/douyin/accounts/local-browsers/{browser_id}',
            path: {
     ...
     * @param data The data for the request.
     * @param data.accountId
     * @returns DouyinAccountBrowserBindResult Successful Response
     * @throws ApiError
     */
    public static listAccountLocalBrowsers(data: DouyinAccountsListAccountLocalBrowsersData): CancelablePromise<DouyinAccountsListAccountLocalBrowsersResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/accounts/by-id/{account_id}/local-browsers',
            path: {
                account_id: data.accountId
            },
            errors: {
    ...
    /**
     * Bind Account Local Browsers Route
     ...
     * @throws ApiError
     */
    public static bindAccountLocalBrowsersRoute(data: DouyinAccountsBindAccountLocalBrowsersRouteData): CancelablePromise<DouyinAccountsBindAccountLocalBrowsersRouteResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/douyin/accounts/by-id/{account_id}/local-browsers',
            path: {
...
export class DouyinCreatorsService {
     ...
     * @throws ApiError
     */
    public static getCreator(data: DouyinCreatorsGetCreatorData): CancelablePromise<DouyinCreatorsGetCreatorResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns DouyinCreatorProfileSyncResult Successful Response
     * @throws ApiError
     */
    public static syncCreatorProfiles(data: DouyinCreatorsSyncCreatorProfilesData): CancelablePromise<DouyinCreatorsSyncCreatorProfilesResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/douyin/creators/profiles/sync',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
...
export class DouyinMineService {
    /**
     * Get Mine Summary
     * 某账号的关注 / 点赞 / 收藏计数与最近采集时间。
     * @param data The data for the request.
     ...
     * @throws ApiError
     */
    public static douyinGetMineSummary(data: DouyinGetMineSummaryData): CancelablePromise<DouyinGetMineSummaryResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/summary',
            query: {
     ...
     * @throws ApiError
     */
    public static douyinGetMineFollowings(data: DouyinGetMineFollowingsData): CancelablePromise<DouyinGetMineFollowingsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/followings',
            query: {
     ...
     * @throws ApiError
     */
    public static douyinPromoteMineFollowings(data: DouyinPromoteMineFollowingsData): CancelablePromise<DouyinPromoteMineFollowingsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/douyin/my/followings/to-creators',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static douyinGetMineAwemes(data: DouyinGetMineAwemesData): CancelablePromise<DouyinGetMineAwemesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/my/awemes',
            query: {
...
export class DouyinUiService {
     ...
     * 返回：
     * 文案映射（缺键时由前端内置默认兜底）。
     * @returns UiLabelsPublic Successful Response
     * @throws ApiError
     */
    public static getUiLabels(): CancelablePromise<DouyinUiGetUiLabelsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/douyin/ui-labels'
        });
    }
}
