...
from app.models import DouyinInteraction, DouyinInteractionEvent
...
class InteractionStepRecorder:
    ...
    async def record(self, page: Page, step: str, detail: str) -> None:
    ...
    async def _capture_via_cdp(self, page: Page) -> bytes:
