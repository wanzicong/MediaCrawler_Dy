...
from app.integrations.douyin.exceptions import DataFetchError, LoginError
from app.integrations.douyin.login import DouyinLogin
from app.integrations.douyin.privacy import anonymize_account_id
...
class DouyinCrawlerService:
    ...
    async def _crawl(self) -> dict[str, str]:
        ...
        if self.account is not None:
            from app.application.douyin.accounts.service import resolve_account_browser
