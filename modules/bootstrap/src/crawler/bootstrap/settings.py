...
# Repository root: modules/bootstrap/src/crawler/bootstrap/settings.py is five
# levels below it. Configuration must resolve identically no matter which
# working directory a process starts from.
