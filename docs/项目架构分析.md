...
| `minio` | compose.infra.yml | 127.0.0.1:9100/9101 | 视频对象存储（bucket 私有，经后端代理访问） |
| `douyin-browser` ×4 | compose.yml 的 `crawler` profile | CDP 9223-9226、noVNC 6081-6084 | 有头 Chrome（Xvfb），登录态存 `douyin-browser-profile` 卷 |
